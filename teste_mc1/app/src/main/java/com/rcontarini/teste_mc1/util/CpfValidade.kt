package com.rcontarini.teste_mc1.util
...
class CpfValidade{
    companion object {
        ...
        fun myValidateCPF(cpf : String) : Boolean{
            ...
            if(cpfClean == "11111111111" || cpfClean == "22222222222" || cpfClean == "33333333333"
                    || cpfClean == "44444444444" || cpfClean == "55555555555" || cpfClean == "66666666666"
                    || cpfClean == "77777777777" || cpfClean == "88888888888" || cpfClean == "99999999999"){
                return false
            }
